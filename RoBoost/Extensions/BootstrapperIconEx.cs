...
namespace RoBoost.Extensions
{
    static class BootstrapperIconEx
    {
        public static IReadOnlyCollection<BootstrapperIcon> Selections => new BootstrapperIcon[]
        {
            ...
            BootstrapperIcon.IconRoBoostClassic,
        ...
        public static Icon GetIcon(this BootstrapperIcon icon)
        {
            ...
            if (icon == BootstrapperIcon.IconCustom)
            {
                ...
                return customIcon ?? Properties.Resources.IconRoBoost;
            }

            return icon switch
            {
                BootstrapperIcon.IconRoBoost => Properties.Resources.IconRoBoost,
                ...
                BootstrapperIcon.IconRoBoostClassic => Properties.Resources.IconRoBoostClassic,
                _ => Properties.Resources.IconRoBoost
            };
        }
    }
}
