...
namespace RoBoost
{
    public static class LaunchHandler
    {
        ...
        public static void LaunchBackgroundUpdater()
        {
            ...
            App.Bootstrapper = new Bootstrapper(launchMode)
            {
                MutexNamePrefix = "RoBoost-BackgroundUpdater",
            ...
            Task.Run(() =>
            {
                ...
                using (EventWaitHandle handle = new EventWaitHandle(false, EventResetMode.AutoReset, "RoBoost-BackgroundUpdaterKillEvent"))
                    handle.WaitOne();
