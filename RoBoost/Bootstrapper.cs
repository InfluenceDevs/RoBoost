...
using RoBoost.AppData;
using RoBoost.RobloxInterfaces;
using RoBoost.UI.Elements.Bootstrapper.Base;
...
namespace RoBoost
{
    public class Bootstrapper
    {
        ...
        public string BackgroundUpdaterMutexName => $"RoBoost-BackgroundUpdater-{_launchMode}";

        public string MutexNamePrefix { get; set; } = "RoBoost-Bootstrapper";
        ...
        private async Task<bool> CheckForUpdates()
        {
            ...
            {
                App.Logger.WriteLine(LOG_IDENT, $"More than one RoBoost instance running, aborting update check");
                return false;
            }
            ...
            SetStatus(Strings.Bootstrapper_Status_UpgradingRoBoost);

            try
            {
#if DEBUG_UPDATER
                string downloadLocation = Path.Combine(Paths.TempUpdates, "RoBoost.exe");
                ...
                catch (Exception ex)
                {
                    ...
                    if (ex.GetType() == typeof(ChecksumFailedException))
                    {
                        ...
                        Frontend.ShowConnectivityDialog(
                            ...
                            String.Format(Strings.Dialog_Connectivity_UnableToDownloadReason, "[https://roboostlabs.com/wiki/help/roboost-cannot-download-roblox/](https://roboostlabs.com/wiki/help/roboost-cannot-download-roblox/)"),
