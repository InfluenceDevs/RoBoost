...
namespace RoBoost.UI.Elements.Bootstrapper
{
    public partial class CustomDialog
    {
        ...
        {
            ["RoBoostCustomBootstrapper"] = HandleXmlElement_RoBoostCustomBootstrapper_Fake,
        ...
        private static void AssertThemeVersion(string? versionStr)
        {
            if (string.IsNullOrEmpty(versionStr))
                throw new CustomThemeException("CustomTheme.Errors.VersionNotSet", "RoBoostCustomBootstrapper");

            if (!uint.TryParse(versionStr, out uint version))
                throw new CustomThemeException("CustomTheme.Errors.VersionNotNumber", "RoBoostCustomBootstrapper");
            ...
            switch (version)
            {
                ...
                case 0: // Themes made between Oct 19, 2024 to Mar 11, 2025 (on the feature/custom-bootstrappers branch)
                    throw new CustomThemeException("CustomTheme.Errors.VersionNotSupported", "RoBoostCustomBootstrapper", version);
                default:
                    throw new CustomThemeException("CustomTheme.Errors.VersionNotRecognised", "RoBoostCustomBootstrapper", version);
            }
        }
        ...
        private void HandleXmlBase(XElement xml)
        {
            ...
            if (xml.Name != "RoBoostCustomBootstrapper")
                throw new CustomThemeException("CustomTheme.Errors.InvalidRoot", "RoBoostCustomBootstrapper");
            ...
            // handle root
            HandleXmlElement_RoBoostCustomBootstrapper(this, xml);
