...
using RoBoost.Models.APIs;
using CommunityToolkit.Mvvm.Input;

namespace RoBoost.Models.Entities
{
    public class ActivityData
    {
        ...
        // everything below here is optional strictly for roboostrpc, discord rich presence, or game history
